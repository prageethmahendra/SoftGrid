...
public final class ServerSap {
	...
	public void startListening(ServerEventListener serverEventListener) throws IOException {
		startListening(serverEventListener, null);
	}

	public void startListening(ServerEventListener serverEventListener, ParameterGenerator parameterGenerator) throws IOException {
		timer = new Timer();
